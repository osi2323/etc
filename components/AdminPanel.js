      ...
      <div className="settings-layout">
        <form onSubmit={saveRequestSettings} className="settings-editor">
          <div className="settings-grid">
            ...
            <label>Teslimat Ürün Özeti Başlığı<input value={requestSettings.delivery_cart_title||''} onChange={e=>setRequestSettings({...requestSettings,delivery_cart_title:e.target.value})}/></label>
            <label>Teslimat Butonu Yazısı<input value={requestSettings.delivery_button_text||''} onChange={e=>setRequestSettings({...requestSettings,delivery_button_text:e.target.value})}/></label>
          ...
          <div className="field-settings-card"><h3>Talep Sonrası Bildirim Ekranı</h3><div className="settings-grid"><label>İkon / Emoji<input value={requestSettings.success_icon||''} onChange={e=>setRequestSettings({...requestSettings,success_icon:e.target.value})} placeholder="✅"/></label><label>Başlık<input value={requestSettings.success_title||''} onChange={e=>setRequestSettings({...requestSettings,success_title:e.target.value})}/></label><label className="wide">Açıklama<textarea rows="3" value={requestSettings.success_message||''} onChange={e=>setRequestSettings({...requestSettings,success_message:e.target.value})}/></label><label>Buton Yazısı<input value={requestSettings.success_button_text||''} onChange={e=>setRequestSettings({...requestSettings,success_button_text:e.target.value})}/></label></div></div>

          <div className="field-settings-card campaign-admin-card"><h3>Haftanın Kampanyaları Kayan Yazısı</h3><p className="muted">Ana sayfadaki eski kategori satırı yerine görünen kayan kampanya şeridini buradan düzenle.</p><div className="settings-grid"><label>Şerit Başlığı<input value={requestSettings.campaign_title||''} onChange={e=>setRequestSettings({...requestSettings,campaign_title:e.target.value})}/></label><label>Kampanya Mesajı 1<input value={requestSettings.campaign_message_1||''} onChange={e=>setRequestSettings({...requestSettings,campaign_message_1:e.target.value})}/></label><label>Kampanya Mesajı 2<input value={requestSettings.campaign_message_2||''} onChange={e=>setRequestSettings({...requestSettings,campaign_message_2:e.target.value})}/></label><label>Kampanya Mesajı 3<input value={requestSettings.campaign_message_3||''} onChange={e=>setRequestSettings({...requestSettings,campaign_message_3:e.target.value})}/></label></div><div className="campaign-admin-preview"><strong>{requestSettings.campaign_title||'HAFTANIN KAMPANYALARI'}</strong><div><span>✦ {requestSettings.campaign_message_1||'Kampanya mesajı'}</span><span>✦ {requestSettings.campaign_message_2||'Kampanya mesajı'}</span></div></div></div>
